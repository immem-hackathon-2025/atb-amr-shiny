...
atb_amrfp_filter_by_taxa <- function(user_taxa=c("Salmonella"), atb_armfp_results_path="AMRFP_results.tsv.gz", atb_armfp_qc_status_path="ATB_AMRFP_status.tsv.gz", atb_species_results_path="ATB_species_calls.tsv.gz"){
...
getAMRfp <- function(species) {
  ...
  write_tsv(amrfp, file=paste0("ATB_",species,"_AFP_preprocessed.tsv.gz"))
